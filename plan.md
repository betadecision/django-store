...
- Використовуємо Python 3.14, як зараз зафіксовано в `.python-version`.
- Використовуємо Django 6.0.5, як зараз зафіксовано в `pyproject.toml` і `uv.lock`.
- Менеджер Python-залежностей: `uv`.
...
1. Навести лад у репозиторії.
   - Заповнити `README.md`: що це за проєкт, стек, як запустити.
...
2. Створити backend skeleton.
   - Створити Django project у `backend/`.
